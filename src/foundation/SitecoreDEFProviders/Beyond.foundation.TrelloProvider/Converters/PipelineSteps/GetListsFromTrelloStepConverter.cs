...
namespace Beyond.foundation.TrelloProvider.Converters.PipelineSteps
{
	public class GetListsFromTrelloStepConverter : BasePipelineStepConverter<ItemModel>
	{
		...
		public GetListsFromTrelloStepConverter(IItemModelRepository repository) : base(repository)
        {
		...
		private void AddEndpointSettings(ItemModel source, PipelineStep pipelineStep)
		{
			...
			var endpointFrom = base.ConvertReferenceToModel<Endpoint>(source, GetListsFromTrelloStepItemModel.EndpointFrom);
